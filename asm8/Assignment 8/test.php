...
function check($cella, $cellab, $cellc){
    $red=$Location_check[$row][$col]*30%255;
    $green=$Location_check[$row][$col]*150%255;
    $blue=$Location_check[$row][$col]*200%255;
...
<form action="test.php">
 ...
 <!----------------------------------------->
    <hr>Cell a
    <input type="text" name="row_a" placeholder = "Input row of cell a">
    <input type="text" name="col_a" placeholder = "Input column of cell a">
    <br>Cell b
    <input type="text" name="row_b" placeholder = "Input row of cell b">
    <input type="text" name="col_b" placeholder = "Input column of cell b">
    <br>Cell c
    <input type="text" name="row_c" placeholder = "Input row of cell c">
    <input type="text" name="col_c" placeholder = "Input column of cell c">
...
if(isset($_GET['submit'])){
    ...
    //For checking
    $r_cella = $_GET['row_a'] -1;
    $col_cella = $_GET['col_a'] -1;

    $r_cellb = $_GET['row_b'] -1;
    $col_cellb = $_GET['col_b'] -1;

    $r_cellc = $_GET['row_c'] -1;
    $col_cellc = $_GET['col_c'] -1;

    $location_check = array();
    $location_check[$cella][$cellb][$cellc] = 0;
